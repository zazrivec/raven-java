...
Details in the [central Maven repository](https://search.maven.org/#artifactdetails%7Cnet.kencochrane.raven%7Craven%7C3.1%7Cjar).

### Manual dependency management
Relies on:

 - [raven-3.1.jar](https://search.maven.org/#artifactdetails%7Cnet.kencochrane.raven%7Craven%7C3.1%7Cjar)
